 ...
 *
 * Usage: node scripts/send-test-email.js your-email@example.com
 */
...
async function sendTestEmail() {
  ...
  if (!testEmail) {
    ...
    console.log('Usage: node scripts/send-test-email.js your-email@example.com\n');
    process.exit(1);
  }
  ...
  console.log('1. Fetching latest newsletter from database...');
...
<body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  ...
  console.log('3. Sending email via Resend...');
  ...
  try {
    ...
    console.log(`\n📬 Check ${testEmail} for the newsletter!\n`);
