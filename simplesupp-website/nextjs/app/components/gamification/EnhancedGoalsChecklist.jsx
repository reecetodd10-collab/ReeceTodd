...
import { loadGamificationData, saveGamificationData, awardXP, checkAchievements } from '../../lib/gamification';
...
export default function EnhancedGoalsChecklist() {
  ...
  const calculateGoals = () => {
    ...
    const todayWorkout = currentWeek?.days?.find(d => d.dayName === currentDayName);
