...
export default function WaterTracker() {
  ...
  const [waterData, setWaterData] = useState(() => {
    if (typeof window === 'undefined') return { dailyGoal: 8, today: 0, lastUpdated: null, history: [] };
    const gamificationData = loadGamificationData();
    return gamificationData.water || { dailyGoal: 8, today: 0, lastUpdated: null, history: [] };
  });
