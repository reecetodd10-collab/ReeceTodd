...
// Prices updated to match Regular Customer Price from master list
...
export const products = [
  ...
  },
  {
    ...
    name: 'L-Glutamine',
    suplifulName: 'L-Glutamine Powder',
    category: PRODUCT_CATEGORIES.PERFORMANCE,
    price: 19.99,
    costPrice: 12.55,
  ...
  },
  {
    ...
    price: 34.99,
    costPrice: 18.00,
    description: 'Premium energy formula for sustained focus and endurance.',
    benefits: ['Sustained energy', 'Enhanced focus', 'No crash', 'Improved endurance'],
    dosage: 'As directed on label',
    goals: ['energy', 'focus'],
    priority: 'high',
    active: true
  ...
  {
    id: 'plant-protein-choc-001',
    name: 'Plant Protein (Chocolate)',
    suplifulName: 'Plant Protein (Chocolate)',
    category: PRODUCT_CATEGORIES.PERFORMANCE,
    price: 39.99,
    costPrice: 22.00,
    description: 'Plant-based protein for muscle recovery. Perfect for vegans and vegetarians.',
    benefits: ['Supports muscle recovery', 'Plant-based', 'Easy to digest', 'Complete amino profile'],
    dosage: '1-2 scoops post-workout',
  ...
  {
    id: 'plant-protein-van-001',
    name: 'Plant Protein (Vanilla)',
    suplifulName: 'Plant Protein (Vanilla)',
    category: PRODUCT_CATEGORIES.PERFORMANCE,
    price: 39.99,
    costPrice: 22.00,
    description: 'Plant-based protein for muscle recovery. Perfect for vegans and vegetarians.',
  ...
  {
    id: 'bcaa-post-workout-001',
    name: 'BCAA Post Workout (Honeydew/Watermelon)',
    suplifulName: 'BCAA Post Workout Powder (Honeydew/Watermelon)',
    category: PRODUCT_CATEGORIES.PERFORMANCE,
    price: 29.99,
    costPrice: 18.65,
    description: 'Post-workout BCAA formula for optimal recovery and muscle repair.',
    benefits: ['Reduces muscle soreness', 'Supports recovery', 'Prevents muscle breakdown', 'Great taste'],
  ...
  },
  {
    ...
    suplifulName: 'Platinum Turmeric',
    category: PRODUCT_CATEGORIES.HEALTH,
    price: 24.15,
    costPrice: 10.09,
  ...
  },
  {
    ...
    suplifulName: 'Probiotic 20 Billion',
    category: PRODUCT_CATEGORIES.HEALTH,
    price: 18.20,
    costPrice: 8.75,
  ...
  },
  {
    ...
    suplifulName: 'Probiotic 40 Billion with Prebiotics',
    category: PRODUCT_CATEGORIES.HEALTH,
    price: 28.20,
    costPrice: 12.45,
  ...
  {
    id: 'energy-powder-fruit-001',
    name: 'Energy Powder (Fruit Punch)',
    suplifulName: 'Energy Powder (Fruit Punch)',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 31.99,
    costPrice: 15.00,
    description: 'Clean energy powder for sustained focus and performance.',
    benefits: ['Clean energy', 'No jitters', 'Enhanced focus', 'Great taste'],
    dosage: '1 scoop as needed',
    goals: ['energy', 'focus'],
    priority: 'high',
    active: true
  },
  {
    id: 'energy-powder-candy-001',
    name: 'Energy Powder (Cotton Candy)',
    suplifulName: 'Energy Powder (Cotton Candy)',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 31.99,
    costPrice: 15.00,
    description: 'Clean energy powder for sustained focus and performance.',
  ...
  {
    id: 'energy-powder-lychee-001',
    name: 'Energy Powder (Lychee Splash)',
    suplifulName: 'Energy Powder (Lychee Splash)',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 31.99,
    costPrice: 15.00,
    description: 'Clean energy powder for sustained focus and performance.',
  ...
  {
    id: 'flow-state-sour-candy-001',
    name: 'Flow State Nootropic (Sour Candy)',
    suplifulName: 'Flow State Nootropic Powder (Sour Candy)',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 34.99,
    costPrice: 18.00,
    description: 'Advanced nootropic formula for peak mental performance and focus.',
    benefits: ['Enhanced focus', 'Mental clarity', 'Improved memory', 'Flow state support'],
    dosage: '1 scoop as needed',
    goals: ['focus', 'energy'],
    priority: 'high',
    active: true
  ...
  {
    id: 'flow-state-gummi-001',
    name: 'Flow State Nootropic (Sour Gummi Worm)',
    suplifulName: 'Flow State Nootropic Powder (Sour Gummi Worm)',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 34.99,
    costPrice: 18.00,
    description: 'Advanced nootropic formula for peak mental performance and focus.',
  ...
  {
    id: 'methylene-blue-001',
    name: 'Methylene Blue Drops',
    suplifulName: 'Methylene Blue Drops',
    category: PRODUCT_CATEGORIES.FOCUS,
    price: 34.99,
    costPrice: 18.00,
    description: 'Powerful nootropic for cellular energy and cognitive enhancement.',
    benefits: ['Cellular energy support', 'Cognitive enhancement', 'Mitochondrial support', 'Antioxidant properties'],
    dosage: 'As directed on label',
    goals: ['focus', 'health'],
    priority: 'high',
    active: true
  ...
  // BEAUTY & SKIN
  {
    ...
    suplifulName: 'Grass-Fed Hydrolyzed Collagen Peptides',
  ...
  },
  {
    ...
    suplifulName: 'Hyaluronic Acid Serum',
    category: PRODUCT_CATEGORIES.BEAUTY,
    price: 28.15,
    costPrice: 8.19,
