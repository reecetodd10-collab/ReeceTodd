...
import { calculateCalories, allMacrosHit, allMealsComplete, getMealCompletionCount } from '../../lib/nutrition';
...
export default function Nutrition() {
  ...
  const [nutritionData, setNutritionData] = useState(() => {
    if (typeof window === 'undefined') return {
      goals: { protein: 150, carbs: 250, fats: 70, calories: 2100, goalType: 'maintenance' },
      today: { date: new Date().toISOString().split('T')[0], protein: 0, carbs: 0, fats: 0, calories: 0, meals: { breakfast: false, lunch: false, dinner: false, preWorkout: false, postWorkout: false } },
      history: [],
    };
    const gamificationData = loadGamificationData();
    return gamificationData.nutrition || {
      goals: { protein: 150, carbs: 250, fats: 70, calories: 2100, goalType: 'maintenance' },
      today: { date: new Date().toISOString().split('T')[0], protein: 0, carbs: 0, fats: 0, calories: 0, meals: { breakfast: false, lunch: false, dinner: false, preWorkout: false, postWorkout: false } },
      history: [],
    };
  ...
  useEffect(() => {
    ...
    setNutritionData(gamificationData.nutrition || {
      goals: { protein: 150, carbs: 250, fats: 70, calories: 2100, goalType: 'maintenance' },
      today: { date: new Date().toISOString().split('T')[0], protein: 0, carbs: 0, fats: 0, calories: 0, meals: { breakfast: false, lunch: false, dinner: false, preWorkout: false, postWorkout: false } },
      history: [],
    });
