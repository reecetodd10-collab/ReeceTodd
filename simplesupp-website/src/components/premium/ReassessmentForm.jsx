  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div>
        ...
        {/* Navigation */}
        <div className="flex justify-between mt-6 pt-6 border-t border-[var(--glass-border)]">
          ...
          <button
            ...
            className={`
              ...
              ${data.goal === goal
                ...
                : 'border-[var(--glass-border)] hover:border-[var(--accent-blue)]/50'
              }
            `}
          >
            {goal}
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-[var(--bg-elev-1)] border border-[var(--glass-border)] rounded-lg"
          />
        </div>
      </div>
    </div>
